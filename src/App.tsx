      ...
      <div className="container mx-auto px-6 lg:px-12 h-20 flex items-center justify-between">
        <div className="flex items-center gap-8">
          ...
          <div className="hidden md:flex gap-6">
            ...
            <a href="https://hadramawth-f58ba.web.app/order" target="_blank" rel="noreferrer" className="text-sm font-medium hover:text-primary transition-colors tracking-wide uppercase">{t('menu')}</a>
            <a href="https://hadramawth-f58ba.web.app/book" target="_blank" rel="noreferrer" className="text-sm font-medium hover:text-primary transition-colors tracking-wide uppercase">{t('reservations')}</a>
            <a href="https://hadramawth-f58ba.web.app/track" target="_blank" rel="noreferrer" className="text-sm font-medium hover:text-primary transition-colors tracking-wide uppercase">{t('track_order')}</a>
          </div>
        </div>
